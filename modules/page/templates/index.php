                    ...
                    <td colspan='4'>
                        <div align='center' style='float:right;'>
                            ...
                            <input type='button' id='apply_element' name='apply_element' class="btn btn-success"
                                   value='Show' onclick='gotoelement(this.id);'/>
                        </div>
                    </td>
                </tr>
                <?php
		    ...
		    unset($impCE->defCols['post_format']);
                ...
                foreach ($impCE->headers as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td><select name="mapping<?php print($count); ?>" id="mapping<?php print($count); ?>"
                                    class="uiButton" onchange="addcustomfield(this.value,<?php echo $count; ?>);">
                ...
                <div class="goto_import_options" align=center>
                    <div class="mappingactions">
                        <input type='button' id='clear_mapping' class='clear_mapping btn btn-warning'
                               name='clear_mapping' value='Clear Mapping' onclick='clearMapping();' style='float:left'/>
                <span style=''>
                        ...
                        <ul id="settings">
                            <li>
                                ...
                                <span class='msg' id='server_request_warning'
                                      style="display:none;color:red;margin-left:-10px;">You can set upto <?php if (isset($_SESSION['SMACK_MAPPING_SETTINGS_VALUES'])) {
