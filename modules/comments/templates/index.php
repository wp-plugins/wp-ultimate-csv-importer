...
<tr>
    <td>
        ...
        <div id='sec-one' <?php if ($_REQUEST['step'] != 'uploadfile') { ?> style='display:none;' <?php } ?>>
            ...
            <?php } ?>
            <form
                action='<?php echo admin_url() . 'admin.php?page=' . WP_CONST_ULTIMATE_CSV_IMP_SLUG . '/index.php&__module=comments&step=mapping_settings' ?>'
                ...
                <div class="importfile" align='center'>
                    ...
                    <form class="add:the-list: validate" style="clear:both;" method="post" enctype="multipart/form-data"
                          onsubmit="return file_exist();">
                        <div class="container">
...
<input type="hidden" id="uploadFileName" name="uploadfilename" value="">
        ...
        <input id="fileupload" type="file" name="files[]" multiple>
                            ...
                            <div class="form-group" style="margin-top: 10px;margin-left: 100px;">
                                <div id="delimeter" class="delimeter"><span>Select your delimeter: <select
                                            name="mydelimeter">
                                            <option value=",">,</option>
                                            <option value=";">;</option>
                                        </select></span></div>
                                <input type='button' name='clearform' id='clearform' value='Clear' onclick="Reload();"
                            ...
                            <div id="defaultpanel" align='center' style='width:100%;'><p class='msgborder'
                                                                                         style='color:green;'> You can
                                    also drag and drop files here</div>
...
<tr>
    <td>
        <form name='mappingConfig'
              action="<?php echo admin_url(); ?>admin.php?page=<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/index.php&__module=comments&step=importoptions"
                                ...
                                <tr>
                                    <td colspan='4'>
                                        <div align='center' style='float:right;'>
                                            ...
                                            <input type='button' id='prev_record' name='prev_record'
                                                   class="btn btn-primary" value='<<' onclick='gotoelement(this.id);'/>
                                            <label style="padding-right:10px;">Change your csv row data</label>
                                            <input type='button' id='next_record' name='next_record'
                                                   class="btn btn-primary" value='>>' onclick='gotoelement(this.id);'/>
                                            Go To Row #<input type='text' id='goto_element' name='goto_element'/>
                                            <input type='button' id='apply_element' name='apply_element' value='Show'
                                ...
                                foreach ($impCE->headers as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span
                                                id='elementVal_<?php echo $key; ?>'> <?php echo $getrecords[0][$key]; ?> </span>
                                        </td>
                                        <td>
                                            <input class="customfieldtext" type="text"
                                                   id="textbox<?php print($count); ?>"
                                                   name="textbox<?php print($count); ?>"
                                                   TITLE="Replace the default value" style="display: none;"
                   ...
                   <img src="../wp-content/plugins/<?php echo WP_CONST_ULTIMATE_CSV_IMP_SLUG; ?>/images/help.png"
                        style="margin-top: 6px;float:right;"/>
                                            ...
                                            <span style="display: none; color: red; margin-left: 5px;"
                                                  id="customspan<?php echo $count ?>">Replace the custom value</span>
                                        </td>
                                    </tr>
                                    <?php
                                    $count++;
                            ...
                            <div class="goto_import_options" align=center>
                                <div class="mappingactions">
                                    <input type='button' id='clear_mapping' class='clear_mapping btn btn-warning'
                                           name='clear_mapping' value='Clear Mapping' onclick='clearMapping();'
                                           style='float:left'/>
                <span style=''>
